...
namespace Cmsify.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911184804_AddIpBanEvents")]
    partial class AddIpBanEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cmsify.Core.Domain.Entities.ContentVersion", b =>
                {
                    ...
                    b.HasIndex("Status", "PublishAt")
                        .HasDatabaseName("ix_content_versions_status_publish_at");

                    b.HasIndex("Status", "PublishAt", "PublishLeaseExpiresAt")
                        .HasDatabaseName("ix_content_versions_status_publish_at_publish_lease_expires_at");
            ...
            modelBuilder.Entity("Cmsify.Core.Domain.Entities.IpBanEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ip_ban_events");

                    b.HasIndex("BannedAt")
                        .HasDatabaseName("ix_ip_ban_events_banned_at");

                    b.HasIndex("IpAddress")
                        .HasDatabaseName("ix_ip_ban_events_ip_address");

                    b.ToTable("ip_ban_events", (string)null);
                });
