...
| `SyntaxCircus.Http.Resilience` | **Adopted; public gate complete** | Exact default-branch-built 0.2.0-cmsify.1 is repository-signed on NuGet.org, integrated across the .NET SDK and Admin, and validated through the isolated public restore gate. |
